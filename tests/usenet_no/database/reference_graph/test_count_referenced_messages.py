...
def test_many_references_to_one_message_count_once(mbox_data, database, load_archives):
...
def test_distinct_targets_count_separately(mbox_data, database, load_archives):
...
def test_each_unknown_id_counts_once(mbox_data, database, load_archives):
