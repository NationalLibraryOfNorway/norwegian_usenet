...
def test_counts_messages_per_newsgroup_of_one_archive(mbox_data, load_archives):
...
def test_date_filtering_excludes_messages_outside_the_span(mbox_data, load_archives):
...
def test_counts_are_sorted_by_newsgroup(mbox_data, load_archives):
    connection = load_archives(
        [
