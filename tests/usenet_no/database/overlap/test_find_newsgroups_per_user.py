...
def test_a_user_posting_repeatedly_gives_one_pair(mbox_data, database, load_archives):
...
def test_the_same_address_is_one_user_whatever_the_name(
...
def test_messages_without_sender_are_left_out(mbox_data, database, load_archives):
...
def test_several_archives_are_read_as_one_body_of_messages(
    mbox_data, database, load_archives
):
...
def test_the_same_newsgroup_in_both_archives_gives_one_pair(
    mbox_data, database, load_archives
):
