...
def test_finds_conflict_within_one_archive_across_newsgroups(mbox_data, load_archives):
...
def test_conflict_order_is_stable_across_runs(mbox_data, load_archives):
