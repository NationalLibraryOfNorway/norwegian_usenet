...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Embed messages from the top N newsgroups in IA and NB archives"
    )
    parser.add_argument(
        "--ia-directory",
        type=Path,
    ...
    nb_top = get_top_n_files(args.nb_directory, args.top_n, args.nb_counts_file)
