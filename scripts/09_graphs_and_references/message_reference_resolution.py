...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/output/09_graphs_and_references/ia_nb_message_id_overlap_date_filtered.json"
        ),
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "data/output/09_graphs_and_references/ia_nb_message_id_comparison_date_filtered.csv"
        ),
