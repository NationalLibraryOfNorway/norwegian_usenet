...
These scripts measure how robust an embedding model is to the U+FFFD (`�`) damage in the IA archive. They come before step 07 because their answer decides which model the embeddings there are made with.
